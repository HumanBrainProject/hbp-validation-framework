	...
	render() {
		return (
			<React.Fragment>
				...
				<Grid item xs={12}>
					<TextField name="description" label="description" value={this.props.value.description}
						onChange={this.handleFieldChange} variant="outlined" fullWidth={true}
						helperText="(optional) Short description of how this version/parameterization of the model is different from others" />
				</Grid>
				<Grid item xs={12}>
					<TextField name="code_format" label="code_format" value={this.props.value.code_format}
						onChange={this.handleFieldChange} variant="outlined" fullWidth={true}
						helperText="(optional)" />
				</Grid>
				<Grid item xs={12}>
