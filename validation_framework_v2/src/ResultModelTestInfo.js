...
function CommonParameter(props) {
	...
	return (
		<TableRow>
			<TableCell style={{ maxWidth: "500px" }}><Typography variant="body2">{m_value}</Typography></TableCell>
			...
			<TableCell style={{ maxWidth: "500px" }}><Typography variant="body2">{t_value}</Typography></TableCell>
		</TableRow>
	)
}
...
export default function ResultModelTestInfo(props) {
	return (
		<Grid container>
					...
					<Grid item>
						<TableContainer component={Paper}>
							<Table>
								<TableHead>
									<TableRow>
										<TableCell align="center" style={{ maxWidth: "500px" }}><Typography variant="body2"><b>Model</b></Typography></TableCell>
										<TableCell align="center" style={{ backgroundColor: "grey" }}><Typography variant="body2"><b>Parameter</b></Typography></TableCell>
										<TableCell align="center" style={{ maxWidth: "500px" }}><Typography variant="body2"><b>Test</b></Typography></TableCell>
									</TableRow>
								</TableHead>
								<TableBody>
									{["id", "uri", "name", "alias", "species", "brain_region", "cell_type"].map((param) => (
										<CommonParameter label={param} m_value={props.model[param]} t_value={props.test[param]} key={param} />
									))}
								</TableBody>
							</Table>
						</TableContainer>
						...
						<Grid item xs={6}>
							<TableContainer component={Paper}>
								<Table>
									<TableHead>
										<TableRow>
											<TableCell align="center" style={{ maxWidth: "500px" }} colSpan={2}><Typography variant="body2"><b>Model</b></Typography></TableCell>
										</TableRow>
									</TableHead>
									<TableBody>
										{["author", "owner", "organization", "app", "private", "model_scope", "abstraction_level"].map((param) => (
											<OtherParameter label={param} value={props.model[param]} key={param} />
										))}
									</TableBody>
								</Table>
							</TableContainer>
						...
						<Grid item xs={6}>
							<TableContainer component={Paper}>
								<Table>
									<TableHead>
										<TableRow>
											<TableCell align="center" style={{ maxWidth: "500px" }} colSpan={2}><Typography variant="body2"><b>Test</b></Typography></TableCell>
										</TableRow>
									</TableHead>
									<TableBody>
										{["author", "status", "creation_date", "data_location", "data_type", "data_modality", "test_type", "score_type"].map((param) => (
											<OtherParameter label={param} value={props.test[param]} key={param} />
										))}
									</TableBody>
								</Table>
							</TableContainer>
					...
					<Grid item>
						<TableContainer component={Paper}>
							<Table>
								<TableBody>
									<TableRow>
										<TableCell><Typography variant="body2"><b>Model Description</b></Typography></TableCell>
									</TableRow>
									<TableRow>
										<TableCell><Typography variant="body2">{props.model.description ? props.model.description : "<< no info >>"}</Typography></TableCell>
									</TableRow>
									<TableRow>
										<TableCell><Typography variant="body2"><b>Test Protocol</b></Typography></TableCell>
									</TableRow>
									<TableRow>
										<TableCell><Typography variant="body2">{props.test.protocol ? props.test.protocol : "<< no info >>"}</Typography></TableCell>
									</TableRow>
								</TableBody>
							</Table>
						</TableContainer>
					...
					<Grid item>
						<TableContainer component={Paper}>
							<Table>
								<TableHead>
									<TableRow>
										<TableCell align="center" style={{ maxWidth: "500px" }}><Typography variant="body2"><b>Model Instance</b></Typography></TableCell>
										<TableCell align="center" style={{ backgroundColor: "grey" }}><Typography variant="body2"><b>Parameter</b></Typography></TableCell>
										<TableCell align="center" style={{ maxWidth: "500px" }}><Typography variant="body2"><b>Test Instance</b></Typography></TableCell>
									</TableRow>
								</TableHead>
								<TableBody>
									{["id", "uri", "version", "timestamp"].map((param) => (
										<CommonParameter label={param} m_value={props.model_instance[param]} t_value={props.test_instance[param]} key={param} />
									))}
								</TableBody>
							</Table>
						</TableContainer>
						...
						<Grid item xs={6}>
							<TableContainer component={Paper}>
								<Table>
									<TableHead>
										<TableRow>
											<TableCell align="center" style={{ maxWidth: "500px" }} colSpan={2}><Typography variant="body2"><b>Model Instance</b></Typography></TableCell>
										</TableRow>
									</TableHead>
									<TableBody>
										{["morphology", "source", "code_format", "parameters", "hash", "license"].map((param) => (
											<OtherParameter label={param} value={props.model_instance[param]} key={param} />
										))}
									</TableBody>
								</Table>
							</TableContainer>
						...
						<Grid item xs={6}>
							<TableContainer component={Paper}>
								<Table>
									<TableHead>
										<TableRow>
											<TableCell align="center" style={{ maxWidth: "500px" }} colSpan={2}><Typography variant="body2"><b>Test Instance</b></Typography></TableCell>
										</TableRow>
									</TableHead>
									<TableBody>
										{["repository", "path", "parameters"].map((param) => (
											<OtherParameter label={param} value={props.test_instance[param]} key={param} />
										))}
									</TableBody>
								</Table>
							</TableContainer>
					...
					<Grid item>
						<TableContainer component={Paper}>
							<Table>
								<TableBody>
									<TableRow>
										<TableCell><Typography variant="body2"><b>Model Instance Description</b></Typography></TableCell>
									</TableRow>
									<TableRow>
										<TableCell><Typography variant="body2">{props.model_instance.description ? props.model_instance.description : "<< no info >>"}</Typography></TableCell>
									</TableRow>
									<TableRow>
										<TableCell><Typography variant="body2"><b>Test Instance Description</b></Typography></TableCell>
									</TableRow>
									<TableRow>
										<TableCell><Typography variant="body2">{props.test_instance.description ? props.test_instance.description : "<< no info >>"}</Typography></TableCell>
									</TableRow>
								</TableBody>
							</Table>
						</TableContainer>
