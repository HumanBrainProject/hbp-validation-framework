...
//             return $resource(window.base_url + '/projects/:id', { id: '@id' }, { update: { method: 'PUT', params: { id: '@id' } } });
//         })
//         .factory('Quotas', function($resource) {
//             return $resource(window.base_url + '/projects/:projectId/quotas/:id', { id: '@id', project_id: '@projectId' });
//         })
