    ...
    return {
        $get: function($http, $log, $q, $rootScope, $timeout, clbEnv, clbError) {
            ...
            function getAuthInfo(authResponse) {
                console.log("in getautinfo, authResponse = ", authResponse);

                authResponse = authResponse || clbAppHello.getAuthResponse('hbp');

                console.log("authResponse = authResponse || clbAppHello.getAuthResponse('hbp'); : ", authResponse)



                if (!authResponse) {
                    // return null;
                    // here return a dict formated like bellow using the window bbpconf

                    //This is the new thing...... the thing bellow is the correct one /////////////////////////////////////////////////////////////////
                    return {
                        accessToken: window.bbpConfig.auth.token.access_token,
                        tokenType: window.bbpConfig.auth.token.token_type,
                        ...
                        scope: undefined,
                        expires: window.bbpConfig.auth.token.expires_in
                    };
