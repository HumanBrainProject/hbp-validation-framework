...
def query_simulations(
    ...
    if model_instance_id:
        model_instance = fairgraph.brainsimulation.ModelInstance.from_uuid(str(model_instance_id), kg_client, api="nexus", release_status="in progress")
        ...
        model_project = fairgraph.brainsimulation.ModelProject.from_uuid(str(model_id), kg_client, api="nexus", release_status="in progress")
...
def get_simulation(simulation_id: UUID, token: HTTPAuthorizationCredentials = Depends(auth)):
    ...
    simulation_activity = fairgraph.brainsimulation.Simulation.from_uuid(str(simulation_id), kg_client, api="nexus", release_status="in progress")
