describe('The model detail and edit views', () => {
    ...
    it('Shows relevant metadata', () => {
      cy.get('h4').should('contain', 'Potjans & Diesmann, 2014 - microcircuit model of early sensory cortex')
    ...
    it('Has version information', () => {
        cy.get(".MuiGrid-item p[variant=subtitle2]").contains("8e8106531f12fcc84c7782f90f326d4a5b1ea991")
    })
