# -*- coding: utf-8 -*-
<<<<<<< HEAD
# Generated by Django 1.11.2 on 2017-06-13 14:49
=======
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ScientificModelImage',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('url', models.URLField(default=b'', help_text=b'Version control repository containing the source code of the model')),
                ('caption', models.TextField(blank=True, null=True)),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='model_validation_api.ScientificModel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.URLField(default=b'', help_text=b'Version control repository containing the source code of the model')),
