...
class ParametersConfigurationModelViewTest(TestCase):
    ...
    def test_get_no_param (self):
        response = client_authorized.get('/parametersconfiguration-model-catalog/', data={})
        
        self.assertEqual(response['location'], "/login/hbp/?next=/parametersconfiguration-model-catalog/")
